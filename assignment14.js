...
//a
let arr=employees.filter(x => x.department == 'IT');
console.log(arr);
//b
let arrm=employees.filter(x => x.Salary < 65000);
console.log(arrm);
...
//a
let arro = hospitals.filter(x => x.noOfBeds > 200)
console.log(arro);
//b
let arrom = hospitals.filter(x => x.availability == "Yes")
console.log(arrom);
//c
let arron = hospitals.filter(x => x.location == "Pune")
console.log(arron);
